...
public class FFTUtilD {
	 ...
	 * @throws Exception
	 */
	public static double[] polymul(
			double []inp,
			double []inq) throws Exception
	{
		int lp = inp.length;
		int lq = inq.length;
		...
		double []rval = new double[r.length];
	 ...
	 * @return
	 */
	public static String spoly(double []inP)
	{
